...
const Features: React.FC = () => (
  <section className="py-12 bg-gray-50">
    <div className="container mx-auto px-6 md:px-12 lg:px-20">
      <h1 className="text-center text-xl lg:text-4xl font-bold text-gray-900 mb-6 font-inter">Why Choose Zidwell Contracts?</h1>
      <p className="text-center text-sm text-gray-500 mb-8 font-inter">Everything you need for professional contract management</p>
